...
class MaterialTheme {
  ...
  static const customColor1 = ExtendedColor(
    seed: Color(0xffc7acff),
    value: Color(0xffc7acff),
    light: ColorFamily(
      color: Color(0xff67548e),
      onColor: Color(0xffffffff),
      colorContainer: Color(0xffeaddff),
      onColorContainer: Color(0xff4f3d74),
    ),
    ...
    dark: ColorFamily(
      color: Color(0xffd2bcfd),
      onColor: Color(0xff38265c),
      colorContainer: Color(0xff4f3d74),
      onColorContainer: Color(0xffeaddff),
    ),
